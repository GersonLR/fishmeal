clear
datos=load('Histamina.txt');

%PANEL 
NCOMP=18              %componentes a seleccionar
pivote=2             %valor diferente de 0 activa la evaluacion de prediccion en el NCOMP seleccionado y variando su número en el rango del pivote seleccionado
i=9                 % orden para matriz de encabezados
...
SeleccionCP=1         %mostrar grafico seleccionCP
Evaluarprediccion=0   %mostrar grafico de prediccion vs real con datos de validación 
EvaluarVIP=0           %Obtener valores VIP para las bandas
bandas=240

Emin=0      %escala minima
Emax=3200    %escala maxima
mostrarleyenda=1
...
%dividimos la data en dos grupos: calibración y validación
    ...
    Xcal=datos(31:122,3:242); % datos de calibracion

    Yval=datos(1:30,2); % datos de validacion
    Xval=datos(1:30,3:242); % datos de validacion
